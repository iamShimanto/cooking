      ...
      <section className='mt-[160px] bg-[#E7F9FD] pb-[80px]'>
        <div className="container">
          <div className="row">
            ...
            <div className='flex items-center gap-[16.96px] w-[234px] h-[60px] rounded-[15px] bg-black px-[32px] py-[19px] mx-auto mt-[80.56px] text-white hover:bg-[#CB9DF0] hover:text-black duration-[0.4s]'>
